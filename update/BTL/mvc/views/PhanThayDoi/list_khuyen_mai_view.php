                ...
                <div class="contentPageServiceList">
                    <div class="row rowPageServiceList">
                        <div class="col-sm-6 col-lg-4 elementSlideLatestNews">
                            <a href="khuyen-mai.htm" title="COMBO HÈ MÁT LẠNH 300.000VND" class="wrapImgResize imgSquare wrapImgItemLatestNews">
                                <img src="public/assets/images/promotion-1.jpg" alt="COMBO HÈ MÁT LẠNH 300.000VND" class="imgItemLatestNews" />
                            </a>

                            <div class="wrapInfoItemLatestNews">
                                <div class="wrapOverInfoItemLatestNews">
                                    <a href="khuyen-mai.htm" class="wrapTitleType3 linkTitleLatestNews" title="COMBO HÈ MÁT LẠNH 300.000VND"><h2 class="titleHeadingLatestNews">Combo Hè Mát Lạnh 300,000VNĐ</h2></a>

                                    <h3 class="descriptionLatestNews">Thời tiết nắng nóng như thế này mà có thể nhảy ùm xuống hồ bơi, nhâm nhi miếng khoai tây chiên giòn giòn, nhấm nháp ngụm nước ngọt lạnh tê lưỡi thì còn gì bằng! Hồ bơi vô cực tuyệt đỉnh tại Masova Hotel nay có nhiều chương trình ưu đãi hấp dẫn phù hợp với nhu cầu của quý khách.</h3>
                        ...
                        <div class="col-sm-6 col-lg-4 elementSlideLatestNews">
                            <a href="khuyen-mai.htm" title="GIẢM GIÁ LÊN ĐẾN 40% CHO KHÁCH ĐẶT TRỰC TIẾP TẠI KHÁCH SẠN" class="wrapImgResize imgSquare wrapImgItemLatestNews">
                                <img src="public/assets/images/room-4.jpg" alt="GIẢM GIÁ LÊN ĐẾN 40% CHO KHÁCH ĐẶT TRỰC TIẾP TẠI KHÁCH SẠN" class="imgItemLatestNews" />
                            </a>

                            <div class="wrapInfoItemLatestNews">
                                <div class="wrapOverInfoItemLatestNews">
                                    <a href="khuyen-mai.htm" class="wrapTitleType3 linkTitleLatestNews" title="GIẢM GIÁ LÊN ĐẾN 40% CHO KHÁCH ĐẶT TRỰC TIẾP TẠI KHÁCH SẠN"><h2 class="titleHeadingLatestNews">Giảm giá lên đến 40% cho khách đặt trực tiếp tại khách sạn</h2></a>

                                    <h3 class="descriptionLatestNews">Khách sạn Masova Hotel xin gửi tới Quý khách và gia đình những ưu đãi đặc biệt để trải nghiệm và chiêm ngưỡng Vịnh Nha Trang xinh đẹp được thiên nhiên ưu đãi.</h3>
